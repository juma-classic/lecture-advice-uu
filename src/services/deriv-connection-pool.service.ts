...
class DerivConnectionPoolService {
    ...
    private readonly appIdConfigs: AppIdConfig[] = [
        {
            appId: '106336', // Your default App ID - UNCHANGED
    ...
    private initializeConnections(): void {
        ...
        console.log('✅ Connection Pool initialized with single App ID (106336) for all features');
