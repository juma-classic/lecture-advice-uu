 ...
 * Format: 1472315[XXXX]1 where XXXX is a stable 4-digit number based on original ID
...
export const generateCustomTransactionId = (originalId: string | number): string => {
    ...
    // Construct the full ID: 1472315 + [4 stable digits] + 1
    return `1472315${paddedMiddleDigits}1`;
};
