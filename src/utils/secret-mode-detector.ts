 ...
 * Desktop: Type "legacy" then press Enter twice
 */
...
class SecretModeDetector {
    ...
    private readonly TARGET_SEQUENCE = 'legacy';
    ...
    private handleKeyDown(e: KeyboardEvent) {
        ...
        if (e.key === 'Enter') {
            ...
            // Keep only the last 6 characters (length of "legacy")
            ...
            if (currentSequence === this.TARGET_SEQUENCE) {
                console.log('✅ Sequence "legacy" typed! Press Enter twice...');
            }
        }
    }
